...
public class InvoicePositions extends TableImpl<InvoicePositionsRecord> {
    ...
    /**
     * The column <code>public.invoice_positions.product_code</code>.
     */
    public final TableField<InvoicePositionsRecord, Integer> PRODUCT_CODE = createField(DSL.name("product_code"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public List<ForeignKey<InvoicePositionsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.INVOICE_POSITIONS__INVOICE_POSITIONS_INVOICE_ID_FKEY, Keys.INVOICE_POSITIONS__INVOICE_POSITIONS_PRODUCT_CODE_FKEY);
    }
    ...
    public Products products() {
        if (_products == null)
            _products = new Products(this, Keys.INVOICE_POSITIONS__INVOICE_POSITIONS_PRODUCT_CODE_FKEY);
