...
public class Organizations extends TableImpl<OrganizationsRecord> {
    ...
    /**
     * The column <code>public.organizations.organizations_name</code>.
     */
    public final TableField<OrganizationsRecord, String> ORGANIZATIONS_NAME = createField(DSL.name("organizations_name"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.organizations.ind_taxpayer_num</code>.
     */
    public final TableField<OrganizationsRecord, Integer> IND_TAXPAYER_NUM = createField(DSL.name("ind_taxpayer_num"), SQLDataType.INTEGER.nullable(false), this, "");
