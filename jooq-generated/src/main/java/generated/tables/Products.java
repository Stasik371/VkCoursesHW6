...
public class Products extends TableImpl<ProductsRecord> {
    ...
    /**
     * The column <code>public.products.name_of_product</code>.
     */
    public final TableField<ProductsRecord, String> NAME_OF_PRODUCT = createField(DSL.name("name_of_product"), SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.products.product_code</code>.
     */
    public final TableField<ProductsRecord, Integer> PRODUCT_CODE = createField(DSL.name("product_code"), SQLDataType.INTEGER.nullable(false), this, "");
